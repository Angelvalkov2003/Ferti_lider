            ...
            <div className="p-6">
                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="ml-4">
                    <input
                      ...
                      checked={true}
                      disabled
                      className="h-5 w-5 text-brand-600 rounded border-gray-300"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-wrap gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                <button
                  ...
                  className="px-6 py-2 text-sm font-medium text-white bg-brand-500 rounded-md hover:bg-brand-600 transition-colors"
                >
                  Запази настройките
                </button>
                <button

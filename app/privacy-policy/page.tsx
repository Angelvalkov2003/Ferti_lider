        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-8 space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300 ml-4">
              ...
              <li>
                Доставка на продуктите чрез Еконт до посочения от вас адрес или офис; при поръчки до 300 € разходите за
                доставка се поемат от клиента;
              </li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300 ml-4">
              ...
              <li>
                <strong>Куриер:</strong> доставките се извършват чрез <strong>Еконт</strong>; споделяме необходимите данни за
                доставка с Еконт за изпълнение на поръчката. Условията за цена на доставката (вкл. за поръчки до 300 €) са
                описани на Сайта;
              </li>
              <li>
